...
func (e *K3sEnv) CertificatePaths() CertificatePaths {
	return CertificatePaths{
		...
		CAFile:  filepath.Join(e.options.Certificate.Path, CACertFileName),
		TLSCert: filepath.Join(e.options.Certificate.Path, CertFileName),
		TLSKey:  filepath.Join(e.options.Certificate.Path, KeyFileName),
	}
}
